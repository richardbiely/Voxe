...
namespace Assets.Engine.Plugins.CoherentNoise.Scripts.Generation.Fractal
{
    ...
    ///     as absolute value, and weighted by previous (i.e. lower-frequency) signal,
    ///     creating a sort of feedback loop. Resulting noise has sharp ridges, somewhat resembling cliffs. This is useful for
    ///     terrain generation.
    /// </summary>
    public class RidgeNoise : FractalNoiseBase
    {
        ...
        /// <summary>
        ///     Exponent defines how fast weights decrease with frequency. The higher the exponent, the less weight is given to
        ///     high frequencies.
        ///     Default value is 1
        /// </summary>
